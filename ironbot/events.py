...
""" Userbot module for managing events.
 One of the main components of the ironbot-reborn. """
...
from ironbot import LOGSPAMMER, PRIVATE_GROUP_ID, bot, client2 as starkclient, client3 as warnerclient
                ...
                if not disable_errors:
                    ...
                    if LOGSPAMMER:
                        await check.client.respond(
                            "`Sorry, my ironbot has crashed.\
                        \nThe error logs are stored in the ironbot's log chat.`"
                        )
