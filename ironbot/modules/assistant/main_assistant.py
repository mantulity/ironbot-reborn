...
from ironbot.modules.sql_helper.blacklist_assistant import (
    add_nibba_in_db,
    is_he_added,
    removenibba,
)
from ironbot.modules.sql_helper.botusers_sql import add_me_in_db, his_userid
from ironbot.modules.sql_helper.idadder_sql import (
    add_usersid_in_db,
    already_added,
    get_all_users,
)
...
async def start(event):
    ...
    if event.sender_id == bot.uid:
        ...
        await tgbot.send_file(
            ...
            link_preview=False,
            buttons=[
                [custom.Button.inline("Deploy your Ironbot", data="deploy")],
                [Button.url("Help Me ❓", "t.me/ironbots")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            event.chat_id,
            message="You Can Deploy Ironbot-reborn In Heroku By Following Steps Bellow, You Can See Some Quick Guides On Support Channel Or On Your Own Assistant Bot. \nThank You For Contacting Me.",
            buttons=[
                [Button.url("Deploy 📺", "")],
