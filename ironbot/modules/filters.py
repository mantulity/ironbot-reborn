...
@iron.on(iron_on_cmd(pattern="filters$"))
@iron.on(sudo_cmd(pattern="filters$", allow_sudo=True))
...
@iron.on(iron_on_cmd(pattern="stop (.*)"))
@iron.on(sudo_cmd(pattern="stop (.*)", allow_sudo=True))
