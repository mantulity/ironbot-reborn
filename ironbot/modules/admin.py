...
from ironbot.function import is_admin
...
@iron.on(iron_on_cmd(pattern="promote(?: |$)(.*)"))
@iron.on(sudo_cmd(pattern="promote(?: |$)(.*)", allow_sudo=True))
...
@iron.on(iron_on_cmd(pattern="demote(?: |$)(.*)"))
@iron.on(sudo_cmd(pattern="demote(?: |$)(.*)", allow_sudo=True))
...
@iron.on(iron_on_cmd(pattern="ban(?: |$)(.*)"))
@iron.on(sudo_cmd(pattern="ban(?: |$)(.*)", allow_sudo=True))
async def ban(event):
    if event.fwd_from:
        return
    if not event.is_group:
...
@iron.on(iron_on_cmd(pattern="unban(?: |$)(.*)"))
@iron.on(sudo_cmd(pattern="unban(?: |$)(.*)", allow_sudo=True))
...
@iron.on(iron_on_cmd(pattern=r"mute(?: |$)(.*)"))
...
@iron.on(iron_on_cmd(pattern="unmute(?: |$)(.*)"))
@iron.on(sudo_cmd(pattern="unmute(?: |$)(.*)", allow_sudo=True))
...
@iron.on(iron_on_cmd(pattern="adminlist$"))
@iron.on(sudo_cmd(pattern="adminlist$", allow_sudo=True))
...
@iron.on(iron_on_cmd(pattern="pin(?: |$)(.*)"))
@iron.on(sudo_cmd(pattern="pin(?: |$)(.*)", allow_sudo=True))
async def pin(event):
    if event.fwd_from:
        return
...
@iron.on(iron_on_cmd(pattern="kick(?: |$)(.*)"))
@iron.on(sudo_cmd(pattern="kick(?: |$)(.*)", allow_sudo=True))
...
@iron.on(iron_on_cmd(pattern="users ?(.*)"))
@iron.on(sudo_cmd(pattern="users ?(.*)", allow_sudo=True))
...
@iron.on(iron_on_cmd(pattern="zombies(?: |$)(.*)"))
@iron.on(sudo_cmd(pattern="zombies(?: |$)(.*)", allow_sudo=True))
