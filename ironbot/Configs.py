...
if not ENV:
    ...
    class Config(object):
        ...
        TEMP_DOWNLOAD_DIRECTORY = os.environ.get("TEMP_DOWNLOAD_DIRECTORY", './ironbot/DOWNLOADS/')
        LOGGER = True
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Ironbotss")
        ...
        LOAD_OTHER_PLUGINS_CHNNL = os.environ.get("LOAD_OTHER_PLUGINS_CHNNL", "")
        #
        # DO NOT EDIT BELOW THIS LINE IF YOU DO NOT KNOW WHAT YOU ARE DOING
        # TG API limit. A message can have maximum 4096 characters!
        MAX_MESSAGE_SIZE_LIMIT = 4095
        # set blacklist_chats where you do not want ironbot's features
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/mabotsss/ironbot-reborn"
        )
        ALIVE_IMAGE = os.environ.get(
            "ALIVE_IMAGE", "https://drive.google.com/uc?id=1-Mnv3SDxJVc0BWAdasEoIlVBtO9PtbCZ&export=download"
        )
        ASSISTANT_START_PIC = os.environ.get(
            "ASSISTANT_START_PIC",
            "https://telegra.ph/file/aece629756cbb1899be93.jpg",
        )
